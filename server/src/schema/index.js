...
type Mutation {
  ...
  updateEvent(id: ID!, title: String!, slug: String!, description: String, photo: String, dateDeadline: String, placeDeadline: String, menuDeadline: String): Event
  ...
  updateParticipant(id: ID!, dates: [ID], places: [ID], menus: [ID]): Participant
}
